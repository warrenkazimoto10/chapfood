-- Fix security issues: Enable RLS on remaining tables and fix policies

-- Enable RLS on tables that don't have it
ALTER TABLE public.carts ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.cart_items ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.cart_item_supplements ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.cart_summary ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Users can view own cart summary" 
ON public.cart_summary 
FOR SELECT 
USING (user_id = auth.uid());
