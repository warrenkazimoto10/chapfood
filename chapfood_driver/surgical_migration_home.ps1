# Migration chirurgicale pour home_screen.dart
$file = "c:/Users/ThinkPad/chapfood/chapfood_driver/lib/screens/home_screen.dart"
...
# 3. Widget Map
# Je vais chercher le bloc GoogleMap et le remplacer par MapboxMapWidget
# C'est délicat avec regex. Je vais chercher "return GoogleMap(" et remplacer jusqu'à ");"
# Mais il y a des parenthèses imbriquées.
# Je vais plutôt commenter le bloc GoogleMap et ajouter le nouveau widget juste avant.
...
# 5. Commenter les méthodes problématiques (Marker/Polyline)
# Je vais commenter les lignes qui utilisent _markers.add, _polylines.add, etc.
...
Write-Host "✅ home_screen.dart migré chirurgicalement!" -ForegroundColor Green
