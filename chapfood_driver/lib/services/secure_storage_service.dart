...
class SecureStorageService {
  ...
  // Clés de stockage
  static const String _driverSessionKey = 'driver_session_secure';
  static const String _authTokenKey = 'auth_token_secure';
  static const String _refreshTokenKey = 'refresh_token_secure';
  static const String _sessionExpiryKey = 'session_expiry';

  /// Sauvegarder la session driver de manière sécurisée
  static Future<void> saveDriverSession(Map<String, dynamic> driverData) async {
    try {
      final jsonData = jsonEncode(driverData);
      await _storage.write(key: _driverSessionKey, value: jsonData);
  ...
  /// Récupérer la session driver
  static Future<Map<String, dynamic>?> getDriverSession() async {
    try {
      ...
      final jsonData = await _storage.read(key: _driverSessionKey);
  ...
  static Future<void> clearSession() async {
    try {
      await _storage.delete(key: _driverSessionKey);
