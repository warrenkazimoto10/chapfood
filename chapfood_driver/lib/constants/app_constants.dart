class AppConstants {
  ...
  static const String permissionErrorMessage = 'Permissions de localisation refusées';
  static const String genericErrorMessage = 'Une erreur est survenue';
  
  // Success Messages
  static const String statusUpdateSuccessMessage = 'Statut mis à jour avec succès';
