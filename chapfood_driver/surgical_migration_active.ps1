# Migration chirurgicale pour active_delivery_screen.dart
...
$content = $content -replace "mapToolbarEnabled: false,", "mapToolbarEnabled: false, */ return MapboxMapWidget(initialPosition: _currentPosition, onMapCreated: _onMapCreated, initialZoom: 15.0,);"
...
Write-Host "✅ active_delivery_screen.dart migré chirurgicalement!" -ForegroundColor Green
